...
namespace ProcHollow
{
	class Program
	{
		...
		static void Main(string[] args)
		{
			...
			Console.WriteLine("[1] Created suspended 'explorer.exe' with PID " + pi.dwProcessId);
            ...
            if (buf2[0] != 'M' || buf2[1] != 'Z')
            {
                Console.WriteLine("Invalid MZ header → imageBaseAddress wrong");
                return;
            }
            ...
            Console.WriteLine($"entryPointRVAOffset = 0x{entryPointRVAOffset:X}");
            Console.WriteLine($"buf2.Length = {buf2.Length}");
